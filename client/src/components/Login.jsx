...
const Login = () => {
  ...
  const hndlsub = async (e) => {
    ...
    if (!uname || !upass) {
      ...
      try {
        const res = await axios.post(`${server}/user/login`, {uname, upass})
                      ...
                      <div className="row gy-3 overflow-hidden">
                        <div className="col-12">
                          <div className="form-floating mb-3">
                            <input type="email" className="form-control border-0 border-bottom rounded-0" name="uname" id="uname" placeholder="name@example.com" onChange={hndlinp} required />
